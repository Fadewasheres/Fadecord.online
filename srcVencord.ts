    ...
    if (!IS_WEB) {
        try {
            ...
            if (Settings.autoUpdate) {
                ...
                if (Settings.autoUpdateNotification)
                    setTimeout(() => showNotification({
                        title: "Fadecord has been updated!",
                        body: "Click here to restart and update",
                        permanent: true,
                        noPersist: true,
                        onClick: relaunch
                    }), 10_000);
            ...
            if (Settings.notifyAboutUpdates)
                setTimeout(() => showNotification({
                    title: "A Fadecord update is available!",
    ...
    if (IS_DEV) {
        ...
        if (pendingPatches.length)
            PMLogger.warn(
                ...
                "You are seeing this warning because this is a Development build of Fadecord.",
